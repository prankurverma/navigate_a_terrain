...
def findOptimumPath(img, listOfMarkers, initial_point, final_point):
    path_array = []
...
## Modify the filepath in this section to test solution for different maze images.           
if __name__ == "__main__":
